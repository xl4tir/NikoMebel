	...
	if(!ADOQuery1->Eof){
		...
		do{
			...
			if(temp_order_num != order_num){
				...
				if(Order_Status == "В процесі" || Order_Status == "Прийнято"){
				   ImgColor  = "blue-back.png";
				}else if(Order_Status == "Відмінено"){
                    ImgColor  = "red-back.png";
				}else if(Order_Status == "Виконано"){
				...
				AnsiString OrderNumLabel = "Замовлення №";

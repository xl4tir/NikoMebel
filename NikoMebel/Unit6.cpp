	...
	: TForm(Owner)
{
			...
			if(!ADOQuery2->Eof){
				...
				do{
					if(ADOQuery1->FieldValues["MeblName"] == ADOQuery2->FieldValues["Name"]){
						...
						DivanRemove->Caption = "Видалити з кошика";
	...
	Label8->Caption = "Сума до сплати: " + IntToStr(FullPrice) + " UAH";
...
void __fastcall TForm6::DeleteLabelClick(TObject *Sender){
     ...
     Message = Message + " видалено із кошика";
